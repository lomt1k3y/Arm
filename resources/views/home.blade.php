    ...
    <style>
        ...
        *,
        ...
        @font-face {
            ...
            src: url('/fonts/test-tiempos-fine-black-italic.woff2');
        }

        .text-with-border {
            color: #1d1d1e;
            /* Устанавливаем белый цвет текста */
            text-shadow: -1px -1px 0 #49494b,
                1px -1px 0 #49494b,
                -1px 1px 0 #49494b,
                1px 1px 0 #49494b;
            /* Создаем теневую темную рамку вокруг букв */
        }
        ...
        .font {
            font-family: "Lugrasimo-Regular", sans-serif;
        }
        ...
        span.outlined-letter::after {
            content: attr(data-letter);
            position: absolute;
            top: -17.1%;
            /* Отступ от верхнего края на 50% высоты родительского элемента */
            left: -5%;
            /* Отступ от левого края на 50% ширины символа */
            z-index: -1;
            color: #86c232;
        }
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <svg id="background" class="absolute -left-20 top-0 max-w-[877px]" xmlns="http://www.w3.org/2000/svg"
            ...
            <g clip-path="url(#a)">
                ...
                <circle cx="558" cy="558" r="557.5" stroke="#172222" opacity=".1"
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    ...
                    <div class="container">
                        ...
                        <p>Ваш Steam ID: {{ $user->steam_id }}</p>
                        
                            <a href="{{ $user->profile_url }}">url</a>
                            @elseif ('asd')
                        ...
                        <p class="text-main">Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum voluptates
                            accusamus cum asperiores consectetur? Saepe laboriosam consequuntur repudiandae libero ea!
                            Soluta rem, voluptates modi ipsum dignissimos expedita alias laudantium labore!</p>
                    </div>
                    <div class="main_title">
                        <div class="title text-wrap">

                            <p class="fw-bold"><span class="text-with-border">role play</span>
                            </p>
                        </div>
                    </div>
</body>
