...
<style>
    ...
    .svg-path {
        transition: fill 0.9s ease;
        /* Плавный переход цвета для пути */
    }
        ...
        <div class="container">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsExample11"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                    ...
                    <path fill="none" stroke="#eb5e28" stroke-linecap="round" stroke-linejoin="round"
                        d="M3 6.001h18m-18 6h18m-18 6h18" />
                </svg>
            </button>

            <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
                <a class="navbar-brand text-white fs-5 col-lg-3 me-0 px-3 menu-items" href="#">arm
                    <span class="badge">new</span>
                </a>
                <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                    <li class="nav-item">
                        <a class="nav-link   fs-6 px-3 menu-items" aria-current="page" href="#">главная</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  fs-6 px-3 menu-items" href="#">играть</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  fs-6 px-3 menu-items" href="#">пополнение</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-lg-flex col-lg-3 justify-content-lg-end">
                    @if (Auth::User())
                        <a href="/home" class="text-decoration-none  fs-5 nav-item-lc"> {{ Auth::User()->name }} </a>
                    @else
                        <a href="{{ route('steamAuth') }}" class="svg-link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon" width="1.8em" height="1.8em"
                                viewBox="0 0 24 24">
                                <rect width="24" height="24" fill="none" />
                                <path class="svg-path" fill="#ADB5BD" opacity="0.8"
