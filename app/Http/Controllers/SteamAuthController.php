...
//             );
//         } catch (\Exception $e) {
//             if ($e->getMessage() === 'Redirect to home') {
//                 return $redirector->to('/home'); // Перенаправление на /home
//             }
//             // Обработка других исключений, если нужно
//         }
    
//         session()->flash('success', 'Вы успешно авторизованы через Steam!');
//         return $redirector->to('/'); // Переход на страницу /
//     }
...
//                 $user->save(); // Сохраняем изменения в базе данных
//             }
//             // Проверяем Steam ID в конце
//             if ($user->steam_id === '76561198398018922') {
//                 throw new \Exception('Redirect to home'); // Выбрасываем исключение для перенаправления
//             }
//             return $user;
//         }
...
//         // Проверяем Steam ID для нового пользователя
//         if ($newUser->steam_id === '76561198398018922') {
//             throw new \Exception('Redirect to home'); // Выбрасываем исключение для перенаправления
//         }
